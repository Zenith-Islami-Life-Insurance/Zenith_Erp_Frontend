 ...
 const { policy_no, policy_status, proposer, amount } = product;
    ...
    return (
            ...
            <div className="flex justify-center">
                    <div className="block p-6 rounded-lg shadow-lg w-full max-w-lg bg-[#087f23]">
                    ...
                    <div className="block p-6 rounded-lg shadow-lg w-full max-w-lg bg-[#087f23]">
                          <div className="form-control">
                            <label className="label cursor-pointer">
                                <span className="label-text text-white  drop-shadow-sm text-lg font-bold">*Select Payable Amount : {amount}</span>
                ...
                <h4 className='mb-2 text-xl font-bold text-dark mt-2  drop-shadow-sm uppercase'>Please Select Payment Gateway</h4>
                      ...
                      <div className="flex justify-center">
                        <div className="block p-6 rounded-lg shadow-lg w-full max-w-lg ">
                               <div className='justify-center lg:flex'>
                         <div className="flex justify-center p-3 m-1 card w-38  bg-base-100 shadow-lg rounded bordered">
