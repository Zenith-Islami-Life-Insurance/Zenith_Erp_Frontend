    ...
    return (
          <div>
            ...
            <div className='flex justify-center mb-52'>
                <div className="card w-full max-w-4xl p-5  shadow-lg rounded ">
 ...
 */}
                        ...
                        {/* <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name='tk' type="number" placeholder='' value={amount} required /> */}
